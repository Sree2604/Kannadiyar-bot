    ...
    <footer className="bg-primecolor text-center font-content text-orange-100  lg:text-left ">
      <div className="mx-6 py-10 text-center md:text-left">
        <div className="grid-1 grid gap-8 lg:grid-cols-5  ">
          {/* TW elements section */}
          <div>
            {/* Content for TW elements section */}
            <img
              src={logo}
              alt="kannadiyar-logo"
              className="ml-2 w-46"
            ...
            <p>
              ...
              ancient Siddha formulations under the brand name of Kannadiyar.
            </p>
          </div>
          ...
          <div>
            ...
            <img
              src={photo1}
              alt="kannadiyar-logo"
              className="ml-2 h-[150px] w-[460px]"
            />
          ...
          <div>
            {/* Content for Useful links section */}
            <img
              src={photo1}
              alt="kannadiyar-logo"
              className="ml-2 h-[150px] w-[460px]"
      ...
      <div className=" p-6 text-center font-content text-primecolor bg-orange-100 flex items-center justify-center border-b-2 lg:justify-between">
        ...
        <div className="lg:justify-center flex">
          <a href="#!" className="lg:mr-6 hidden lg:block  text-primecolor">
            {/* SVG for social network icon */}
            <svg
              xmlns="http://www.w3.org/2000/svg"
          ...
          <a href="#!" className="lg:mr-6 hidden lg:block text-primecolor">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              className="h-4 w- hidden lg:block4"
              fill="currentColor"
              viewBox="0 0 24 24"
            >
